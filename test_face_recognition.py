...
class Test_face_recognition(unittest.TestCase):
    ...
    def test_load_img_file(self):
        img = api.load_img_file(os.path.join(os.path.dirname(__file__), 'test_img', 'obama.jpg'))
        self.assertEqual(img.shape, (1137, 910, 3))

    def test_load_img_file_32bit(self):
        img = api.load_img_file(os.path.join(os.path.dirname(__file__), 'test_img', '32bit.png'))
    ...
    def test_partial_face_loc(self):
        img = api.load_img_file(os.path.join(os.path.dirname(__file__), 'test_img', 'obama_partial_face.jpg'))
        detected_faces = api.face_locations(img)

        self.assertEqual(len(detected_faces), 1)
        self.assertEqual(detected_faces[0], (142, 191, 365, 0))

        img = api.load_img_file(os.path.join(os.path.dirname(__file__), 'test_img', 'obama_partial_face2.jpg'))
        detected_faces = api.face_locations(img)
    ...
    def test_raw_face_loc_batched(self):
        img = api.load_img_file(os.path.join(os.path.dirname(__file__), 'test_img', 'obama.jpg'))
        images = [img, img, img]
        batched_detected_faces = api._raw_face_locations_batched(img, number_of_times_to_upsample=0)
    ...
    def test_batched_face_loc(self):
        ...
        batched_detected_faces = api.batch_face_locations(img, number_of_times_to_upsample=0)
    ...
    def test_face_landmarks(self):
        img = api.load_image_file(os.path.join(os.path.dirname(__file__), 'test_img', 'obama.jpg'))
    ...
    def test_face_distance(self):
        img_a1 = api.load_image_file(os.path.join(os.path.dirname(__file__), 'test_img', 'obama.jpg'))
        img_a2 = api.load_image_file(os.path.join(os.path.dirname(__file__), 'test_img', 'obama2.jpg'))
        img_a3 = api.load_image_file(os.path.join(os.path.dirname(__file__), 'test_img', 'obama3.jpg'))

        img_b1 = api.load_image_file(os.path.join(os.path.dirname(__file__), 'test_img', 'biden.jpg'))
    ...
    def test_face_distance_empty_lists(self):
        img = api.load_image_file(os.path.join(os.path.dirname(__file__), 'test_img', 'biden.jpg'))
    ...
    def test_compare_faces(self):
        img_a1 = api.load_img_file(os.path.join(os.path.dirname(__file__), 'test_img', 'obama.jpg'))
        img_a2 = api.load_img_file(os.path.join(os.path.dirname(__file__), 'test_img', 'obama2.jpg'))
        img_a3 = api.load_img_file(os.path.join(os.path.dirname(__file__), 'test_img', 'obama3.jpg'))

        img_b1 = api.load_img_file(os.path.join(os.path.dirname(__file__), 'test_img', 'biden.jpg'))
    ...
    def test_compare_faces_empty_lists(self):
        img = api.load_img_file(os.path.join(os.path.dirname(__file__), 'test_img', 'biden.jpg'))
        face_encoding = api.face_encodings(img)[0]
    ...
    def test_command_line_interface(self):
        ...
        runner = CliRunner()
        img_folder = os.path.join(os.path.dirname(__file__), 'test_img')
        img_file = os.path.join(os.path.dirname(__file__), 'test_img', 'obama.jpg')

        result = runner.invoke(face_recognition_cli.main, args=[img_folder, img_file])

        self.assertEqual(result.exit_code, 0)
        self.assertTrue(target_string in result.output)

    def test_command_line_interface_big_img(self):
        target_string = 'obama3.jpg,obama'
        runner = CliRunner()
        img_folder = os.path.join(os.path.dirname(__file__), 'test_img')
        img_file = os.path.join(os.path.dirname(__file__), 'test_img', 'obama3.jpg')
    ...
    def test_command_line_interface_tolerance(self):
        ...
        result = runner.invoke(face_recognition_cli.main, args=[img_folder, img_file, "--tolerance", "0.55"])
    ...
    def test_command_line_interface_show_distance(self):
        ...
        result = runner.invoke(face_recognition_cli.main, args=[img_folder, img_file, "--show-distance", "1"])
    ...
    def test_fd_command_line_interface(self):
        ...
        result = runner.invoke(face_detection_cli.main, args=[img_file])
        self.assertEqual(result.exit_code, 0)
    ...
    def test_fd_command_line_interface_folder(self):
        runner = CliRunner()
        image_file = os.path.join(os.path.dirname(__file__), 'test_img')

        result = runner.invoke(face_detection_cli.main, args=[img_file])
        self.assertEqual(result.exit_code, 0)
        self.assertTrue("obama_partial_face2.jpg" in result.output)
        self.assertTrue("obama1.jpg" in result.output)
